...
const SchoolManagementPage = () => {
  ...
  const featuresList = [
    ...
    { key: 'admitcard', label: 'Admit Card',icon: '🎟️' }
  ];
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {featuresList.map((feature) => (
                  <div
                    key={feature.key}
                    className={`border-2 rounded-lg p-4 transition-all cursor-pointer ${viewSchool.features?.[feature.key]
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${viewSchool.features?.[feature.key]
                            ? 'bg-green-500'
                            : 'bg-gray-300'
                          }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${viewSchool.features?.[feature.key]
                              ? 'translate-x-6'
                              : 'translate-x-1'
                            }`}
                        />
